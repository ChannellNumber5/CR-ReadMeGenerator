...
const questions = [
    ...
    {type:"input", name:"description", message:"Please provide a short description of your project/app:"}, 
    {type:"input", name:"installationSteps", message: "Are there steps required for installation? If so please describe them here:"}, 
    {type:"input", name:"instructions", message:"Please provide quick instructions for use of your project/app:"},
    {type:"input", name:"tests", message:"Please describe out the requirements and instructions for testing your project/app:"},
